...
EXPORT_FUNC(PyDict_IsLazyImport)
...
EXPORT_FUNC(PyDict_NextWithError)
EXPORT_FUNC(PyDict_ResolveLazyImports)
...
EXPORT_FUNC(PyImport_IsLazyImportsEnabled)
EXPORT_FUNC(PyImport_ReloadModule)
EXPORT_FUNC(PyImport_SetLazyImports)
EXPORT_FUNC(PyImport_SetLazyImportsInModule)

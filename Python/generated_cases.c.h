...
// Do not edit!
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1872 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1930 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2060 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = str;
            DISPATCH();
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 2073 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_SET) {
            ...
            #line 2151 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = set;
            DISPATCH();
        ...
        TARGET(MAP_ADD) {
            ...
            #line 2300 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            PREDICT(JUMP_BACKWARD);
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_LOAD_SUPER_ATTR) {
            ...
            #line 2313 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LOAD_SUPER_ATTR_METHOD) {
            ...
            #line 2441 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2489 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(LOAD_ATTR_WITH_HINT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2639 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_SLOT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2664 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(STORE_ATTR_INSTANCE_VALUE) {
            ...
            Py_DECREF(owner);
            #line 2789 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(GET_YIELD_FROM_ITER) {
            ...
            #line 3353 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
            #line 2378 "Python/bytecodes.c"
            }
            #line 3357 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(FOR_ITER) {
            ...
            #line 3399 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        end_for_iter_list:
            // Common case: no jump, leave it to the code generator
            #line 3460 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(KW_NAMES) {
            #line 2695 "Python/bytecodes.c"
            assert(kwnames == NULL);
            assert(oparg < PyTuple_GET_SIZE(frame->f_code->co_consts));
            kwnames = GETITEM(frame->f_code->co_consts, oparg);
            #line 3782 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL) {
            ...
            #line 3892 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4035 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4060 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4269 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LIST_APPEND) {
            ...
            DISPATCH();
            #line 4339 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4502 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(FORMAT_VALUE) {
            ...
            #line 4726 "Python/generated_cases.c.h"
        ...
        TARGET(COPY) {
            ...
            #line 4738 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4765 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);

...
// Do not edit!
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1908 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(MAKE_CELL) {
            ...
            SETLOCAL(oparg, cell);
            #line 1936 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 1952 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(STORE_DEREF) {
            ...
            PyCell_SET(cell, v);
            Py_XDECREF(oldobj);
            #line 2022 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2054 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = str;
            DISPATCH();
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 2067 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 1576 "Python/bytecodes.c"
            if (map == NULL) { STACK_SHRINK(oparg*2); goto error; }
            #line 2166 "Python/generated_cases.c.h"
        ...
        TARGET(SETUP_ANNOTATIONS) {
            ...
            #line 2214 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2260 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            #line 2360 "Python/generated_cases.c.h"
            ...
            Py_DECREF(super);
            if (res == NULL) goto pop_3_error;
            #line 2369 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_SUPER_ATTR_METHOD) {
            ...
            #line 2435 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR) {
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2483 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
            ...
            #line 2494 "Python/generated_cases.c.h"
                Py_DECREF(owner);
        ...
        TARGET(LOAD_ATTR_INSTANCE_VALUE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2526 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(STORE_ATTR_INSTANCE_VALUE) {
            ...
            Py_DECREF(owner);
            #line 2783 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 2884 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(IS_OP) {
            ...
            #line 2973 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            b = res ? Py_True : Py_False;
            #line 3051 "Python/generated_cases.c.h"
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(GET_LEN) {
            ...
            #line 3231 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(INSTRUMENTED_FOR_ITER) {
            ...
            #line 3426 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(FOR_ITER_RANGE) {
            ...
            #line 3511 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3575 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(WITH_EXCEPT_START) {
            ...
            */
            ...
            if (res == NULL) goto error;
            #line 3660 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(PUSH_EXC_INFO) {
            ...
            #line 3679 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3734 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(KW_NAMES) {
            ...
            #line 3775 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_CALL) {
            ...
            #line 3793 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_WITH_DEFAULTS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3986 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4089 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4131 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 4177 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            ...
            INSTRUMENTED_JUMP(next_instr-1, next_instr-oparg, PY_MONITORING_EVENT_JUMP);
            #line 4807 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            ...
            #line 4822 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CACHE) {
            ...
            Py_UNREACHABLE();
            #line 4888 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3565 "Python/bytecodes.c"

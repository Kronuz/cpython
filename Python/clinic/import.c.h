...
"_set_lazy_imports($module, enabled=True, /, eager=<unrepresentable>)\n"
"--\n"
"\n"
...
_imp__set_lazy_imports(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    static const char * const _keywords[] = {"", "eager", NULL};
    static _PyArg_Parser _parser = {
        .keywords = _keywords,
...
skip_optional_posonly:
    ...
    eager = args[1];
skip_optional_pos:
    return_value = _imp__set_lazy_imports_impl(module, enabled, eager);
...
/*[clinic end generated code: output=479e17b426446098 input=a9049054013a1b77]*/

...
_PyImport_IsLazyImportsEnabledTstate(PyThreadState *tstate)
{
    ...
    if (frame->lazy_imports_cache_seq != tstate->interp->lazy_imports_cache_seq) {
        ...
        frame->lazy_imports_cache_seq = tstate->interp->lazy_imports_cache_seq;
    }
    return lazy_imports;
}
